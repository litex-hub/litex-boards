...
# TODO:
# 1. TMDS lanes for the HDMI connector
# 2. Populate more SFPs

_io = [
    ("clk20_vcxo", 0, Pins("D17"), IOStandard("LVCMOS33")),
    ("vcxo_en", 0, Pins("E13"), IOStandard("LVCMOS33")),  # Enable for the above clock
    ...
    ("eth_clocks", 0,
     ...
     IOStandard("LVCMOS25")),
    ("eth", 0, Subsignal("rx_ctl", Pins("H15"), Misc("IOB=TRUE")),
     Subsignal("rx_data", Pins("K13 H14 J14 K14"), Misc("IOB=TRUE")),
     Subsignal("tx_ctl", Pins("J16"), Misc("IOB=TRUE"), Misc("SLEW=FAST")),
    ...
    ("ddram",
        0,
        Subsignal("a",
                  Pins("L6 M5 P6 K6 M1 M3 N2 M6", "P1 P2 L4 N5 L3 R1 N3 E3"),
                  IOStandard("SSTL135")),
...
class Platform(XilinxPlatform):
    def __init__(self):
        XilinxPlatform.__init__(
            self, "xc7a100t-2fgg484", _io, _connectors, toolchain="vivado")
