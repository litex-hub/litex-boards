...
_io = [
    ...
    # HDMI
    ("hdmi_out", 0,
        Subsignal("txp",   Pins("AN6 AM4 AL6")),
        Subsignal("txn",   Pins("AN5 AM3 AL5")),
        Subsignal("clk_p", Pins("G21"), IOStandard("LVDS")),
        Subsignal("clk_n", Pins("F21"), IOStandard("LVDS")),
        Subsignal("scl",   Pins("N8"),  IOStandard("LVCMOS33")),
        Subsignal("sda",   Pins("N9"),  IOStandard("LVCMOS33")),
        Subsignal("en",    Pins("N11"), IOStandard("LVCMOS33")),
        Subsignal("cec",   Pins("M12"), IOStandard("LVCMOS33")),
        Subsignal("hpd",   Pins("N13"), IOStandard("LVCMOS33")),
    ),
    ("hdmi_in", 0,
        Subsignal("rxp",     Pins("AP4 AN2 AL2")),
        Subsignal("rxn",     Pins("AP3 AN1 AL1")),
        Subsignal("clk_p",   Pins("AC10")),
        Subsignal("clk_n",   Pins("AC9")),
        Subsignal("hpd",     Pins("M10"), IOStandard("LVCMOS33")),
        Subsignal("pwr_det", Pins("M8"),  IOStandard("LVCMOS33")),
        Subsignal("scl",     Pins("M9"),  IOStandard("LVCMOS33")),
        Subsignal("sda",     Pins("M11"), IOStandard("LVCMOS33")),
    ),
    ("hdmi_ctl", 0,
        Subsignal("scl",        Pins("N12"), IOStandard("LVCMOS33")),
        Subsignal("sda",        Pins("P12"), IOStandard("LVCMOS33")),
        Subsignal("clkgen_lol", Pins("G8"),  IOStandard("LVCMOS33")),
        Subsignal("clkgen_rst", Pins("H8"),  IOStandard("LVCMOS33")),
        Subsignal("rec_clk_p",  Pins("G14"), IOStandard("LVDS")),
        Subsignal("rec_clk_n",  Pins("F13"), IOStandard("LVDS")),
        Subsignal("refclk_p",   Pins("AD8")),
        Subsignal("refclk_n",   Pins("AD7")),
    ),
