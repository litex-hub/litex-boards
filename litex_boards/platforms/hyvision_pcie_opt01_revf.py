...
_io = [
    ...
    ("ddram", 0,
        ...
        Subsignal("dq",    Pins(
            ...
            #"AA4 AB4 AC4 AC3 AC6 Y6 Y5 AD6 AD1 AE1 AE3 AE2 AE6 AE5 AF3 AF2"), # Issue with second DDR2 Chip.
            IOStandard("SSTL18_II")),
        # Second DDR2 Chip disabled (wrong pinout?).
        ...
        Subsignal("dqs_p", Pins("W6 AB1"),         IOStandard("DIFF_SSTL18_II")),
        Subsignal("dqs_n", Pins("W5 AC1"),         IOStandard("DIFF_SSTL18_II")),
        Subsignal("clk_p", Pins("V11"),            IOStandard("DIFF_SSTL18_II")),
        Subsignal("clk_n", Pins("W11"),            IOStandard("DIFF_SSTL18_II")),
        Subsignal("dm",    Pins("U6 Y3"),          IOStandard("SSTL18_II")),
        Subsignal("odt",   Pins("AA13"),           IOStandard("SSTL18_II")),
        Subsignal("cs_n",  Pins("AD9"),            IOStandard("SSTL18_II")),
        Misc("SLEW=FAST"),
    ),
