...
_io = [
    ...
    ("spisdcard", 0,
        ...
        Subsignal("cs_n", Pins("IO_NA_A1"), Misc("PULLUP=true")),
        Subsignal("miso", Pins("IO_NA_A2"), Misc("PULLUP=true")),
    ),

    ("sdcard", 0,
        Subsignal("data", Pins("IO_NA_A2 IO_NA_B2 IO_NB_A5 IO_NA_A1"), Misc("PULLUP=true")),
