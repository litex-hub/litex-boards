...
_io = [
    ...
    # rst
    ("rst_n", 0, Pins("J17"), IOStandard("3.3-V LVTTL")),

    # Button
    ("key", 0, Pins("J17"),  IOStandard("3.3-V LVTTL")),
    ("key", 1, Pins("E16"),  IOStandard("3.3-V LVTTL")),
    ...
    ("sdram", 0,
        Subsignal("a",     Pins(
            " M20 M16 L17 L19 L18 K16 K17 J18 J19 N19 H18 H20")),
        ...
        Subsignal("dq", Pins(
            "AA22 AB22 Y22 Y21 W22 W21 V21 U22 M21 M22 T22 R21 R22 P22 N20 N21 K22 K21 J22 J21 H21 G22 G21 F22 E22 E20 D22 D21 C21 B22 A22 B21 ")),
...
class Platform(AlteraPlatform):
    ...
    core_resources = [
        ("user_led", 0, Pins("V19"), IOStandard("3.3-V LVTTL")),
        ("user_led", 1, Pins("T20"), IOStandard("3.3-V LVTTL")),
        ("serial", 0,
            Subsignal("tx", Pins("J2:15"), IOStandard("3.3-V LVTTL")),
            Subsignal("rx", Pins("J2:16"), IOStandard("3.3-V LVTTL"))
        ),
 ]
    ...
    def __init__(self, toolchain="quartus", with_daughterboard=False):
        ...
        if with_daughterboard:
            ...
            # with the below lines MAYBE you can syntehsize a RV64 Rocket
            self.add_platform_command("set_global_assignment -name VERILOG_MACRO \"SYNTHESIS=1\"")
            self.add_platform_command("set_global_assignment -name OPTIMIZATION_MODE \"Aggressive Area\"")
            self.add_platform_command("set_global_assignment -name ALM_REGISTER_PACKING_EFFORT HIGH")
