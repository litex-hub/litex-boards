...
from litex_boards.platforms import microfpga_mf001_intel
...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=116e6,
        ...
        with_mfio   = True,
        **kwargs):
        platform = microfpga_mf001_intel.Platform(platform_id)
...
def main():
    ...
    parser = LiteXArgumentParser(platform=microfpga_mf001_intel.Platform, description="LiteX SoC on MicroFPGA Intel.")
