...
from litex_boards.platforms import qmtech_xc7a200t
...
class BaseSoC(SoCCore):
    def __init__(self, toolchain="vivado", sys_clk_freq=100e6, with_daughterboard=False,
        ...
        **kwargs):
        platform = qmtech_xc7a200t.Platform(toolchain=toolchain, with_daughterboard=with_daughterboard)
        ...
        SoCCore.__init__(self, platform, sys_clk_freq,
            ident = "LiteX SoC on QMTech XC7A200T" + (" + Daughterboard" if with_daughterboard else ""),
            **kwargs)
...
def main():
    ...
    parser = LiteXArgumentParser(platform=qmtech_xc7a200t.Platform, description="LiteX SoC on QMTech XC7A200T.")
