...
from litex_boards.platforms import alchitry_au_v2
...
class BaseSoC(SoCCore):
    def __init__(self, variant="au_v2", sys_clk_freq=100e6,
        ...
        **kwargs):
        platform = alchitry_au_v2.Platform(variant=variant)

        # CRG --------------------------------------------------------------------------------------
        self.crg = CRG(platform, sys_clk_freq)

        # SoCCore ----------------------------------------------------------------------------------
        SoCCore.__init__(self, platform, sys_clk_freq, ident="LiteX SoC on Alchitry Au v2", **kwargs)
