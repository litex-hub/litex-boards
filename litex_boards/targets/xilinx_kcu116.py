...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=125e6,
        ...
        **kwargs):
        ...
        # SoCCore ----------------------------------------------------------------------------------
        SoCCore.__init__(self, platform, sys_clk_freq, ident="LiteX SoC on KCU116", **kwargs)
        ...
        if with_sata:
            ...
            _sata_io = [
                ...
                ("sfp2sata", 0,
                 Subsignal("tx_p", Pins("N5")),
                 Subsignal("tx_n", Pins("N4")),
                 Subsignal("rx_p", Pins("M2")),
                 Subsignal("rx_n", Pins("M1")),
                ),
            ]
