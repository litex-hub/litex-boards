...
class BaseSoC(SoCCore):
    def __init__(self, *, sys_clk_freq=200e6, iodelay_clk_freq=200e6,
        ...
        **kwargs):
        ...
        # SoCCore ----------------------------------------------------------------------------------
        SoCCore.__init__(self, platform, sys_clk_freq, ident="LiteX SoC on Antmicro DDR5 Tester", **kwargs)
        ...
        if not self.integrated_main_ram_size:
            ddr5, module_cls = get_ddr5_support("M329R8GA0BB0")
        ...
        # System I2C -------------------------------------------------------------------------------
        self.i2c = I2CMaster(platform.request("i2c"), default_dev=True)
...
def main():
    ...
    parser = LiteXArgumentParser(platform=antmicro_ddr5_tester.Platform, description="LiteX SoC on Antmicro DDR5 Tester.")
